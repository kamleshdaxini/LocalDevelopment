<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="ScopeDocumentStandalone.aspx.cs" Inherits="ScopeDocumentDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cntplh" runat="Server">
    <asp:UpdatePanel ID="upnl" runat="server">
        <ContentTemplate>
            <div style="border: 1px none #7F9DB9; width: 100%;  overflow: auto;
                text-align: center;" id="divSize">
                            ...
                            <table width="100%" align="center">
                                ...
                                <tr>
                                    <td align="left" width="100%">
                                            ...
                                            <asp:TabContainer ID="TabContainer134" runat="server" ActiveTabIndex="0"
                                                ScrollBars="Auto" Width="100%"  Style="margin-top: 0px;visibility:visible;">
                                                    ...
                                                    <ContentTemplate>
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" width="70%">
                                                                    <uc:MultiselectList ID="ddlmslCurrKey" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="left" width="30%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="left" width="70%">
                                                                    <uc:MultiselectList ID="ddlmslTargetAudience" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="30%">
                                                                ...
                                                                <td width="70%">
                                                                    <uc:MultiselectList ID="ddlmslIndustries" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="30%">
                                                                ...
                                                                <td width="70%">
                                                                    <uc:MultiselectList ID="ddlmslSpecialities" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="30%">
                                                                ...
                                                                <td width="70%">
                                                                    <uc:MultiselectList ID="ddlmslFunctions" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="30%">
                                                    ...
                                                    <ContentTemplate>
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left" width="70%">
                                                                    <uc:MultiselectList ID="ddlmslStkResource" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="text-align: left;" width="30%">
                                                    ...
                                                    <ContentTemplate>
                                                        <table width="100%">
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlAligALD" runat="server" Width="70%" AutoPostBack="True"
                                                                        OnSelectedIndexChanged="ddlAligALD_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlAligKPMG" runat="server" Width="70%" AutoPostBack="True"
                                                                        OnSelectedIndexChanged="ddlAligKPMG_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlBusImpOnPeo" runat="server" Width="70%" AutoPostBack="True"
                                                                        OnSelectedIndexChanged="ddlBusImpOnPeo_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlBusImpOnProcess" runat="server" Width="70%" AutoPostBack="True"
                                                                        OnSelectedIndexChanged="ddlBusImpOnProcess_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlBusImpOnBottLine" runat="server" Width="70%" AutoPostBack="True"
                                                                        OnSelectedIndexChanged="ddlBusImpOnBottLine_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlCostBugImp" runat="server" Width="70%" AutoPostBack="True"
                                                                        OnSelectedIndexChanged="ddlCostBugImp_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlCostReaso" runat="server" Width="70%" AutoPostBack="True"
                                                                        OnSelectedIndexChanged="ddlCostReaso_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlRiskKPMG" runat="server" Width="70%" AutoPostBack="True"
                                                                        OnSelectedIndexChanged="ddlRiskKPMG_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlRiskALD" runat="server" Width="70%" AutoPostBack="True"
                                                                        OnSelectedIndexChanged="ddlRiskALD_SelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <asp:TabPanel ID="TabPanel5" runat="server" HeaderText="Course/Program/Planning/Innovation Team">
                                                    <ContentTemplate>
                                                        <table width="100%">
                                                            <tr>
                                                                <td width="30%">
                                                                    <asp:Label ID="lblSRM" runat="server" Text="Stakeholder Relationship Manager"></asp:Label>
                                                                </td>
                                                                <td class="style3" width="70%">
                                                                    <asp:DropDownList ID="ddlSRM" runat="server" Width="70%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <asp:DropDownList ID="ddlPortMana" runat="server" Width="70%">
                                                                    </asp:DropDownList>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td width="70%">
                                                                    <uc:MultiselectList ID="ddlmslInsDes" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="30%">
                                                                ...
                                                                <td width="70%">
                                                                    <uc:MultiselectList ID="ddlmslConDev" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="30%">
                                                                ...
                                                                <td width="70%">
                                                                    <uc:MultiselectList ID="ddlmslPrgLead" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td width="30%">
                                                                ...
                                                                <td width="70%">
                                                                    <uc:MultiselectList ID="ddlmslDelLead" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ContentTemplate>
                                                    ...
                                                    <ContentTemplate>
                                                        <table style="width: 100%">
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left" width="70%">
                                                                    <uc:MultiselectList ID="ddlmslRecRevType" runat="server" panWidth="300" txtWidth="300" />
                                                                </td>
                                                                <td colspan="2">
                                                                    &nbsp;
                                                                </td>
                                                    ...
                                                    <ContentTemplate>
                                                        <table width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left" width="70%">
                                                                    <asp:TextBox ID="txtWillRemindReg" runat="server" Width="70%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="text-align: left;" width="30%">
                                                                    <asp:Label ID="lblProPlanDet" runat="server" Text="Provisional plan details:"></asp:Label>
                                                                </td>
                                                                <td style="text-align: left" width="70%">
                                                                    <asp:TextBox ID="txtProPlanDet" runat="server" Width="70%"></asp:TextBox>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </ContentTemplate>
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="grdMeasurement" runat="server" AutoGenerateColumns="False" Width="100%">
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Sr. No.">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblMeaSrNo" runat="server" Text='<%#Container.DataItemIndex + 1 %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Session#">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblMeaWhat" runat="server" Text='<%# Eval("What") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Max Pax">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblToWhom" runat="server" Text='<%# Eval("To Whom") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Start Time">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblWhenLAunDate" runat="server" Text='<%# Eval("When Launched Date") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="End Time">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblLaunchVeh" runat="server" Text='<%# Eval("Launch Description") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="End Time">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblForVeh" runat="server" Text='<%# Eval("Format Vehicle") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="End Time">
                                                                    <ItemTemplate>
                                                    ...
                                                    <ContentTemplate>
                                                        <asp:GridView ID="grdcommunication_plnaDetails" runat="server" AutoGenerateColumns="False"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="Sr. No.">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblCommSrNo" runat="server" Text='<%#Container.DataItemIndex + 1 %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="What">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblCommWhat" runat="server" Text='<%# Eval("What") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Who">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblCommWho" runat="server" Text='<%# Eval("Who") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="When">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblWhen" runat="server" Text='<%# Eval("When") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Format/Vehicle">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblFormat" runat="server" Text='<%# Eval("Format/Vehicle") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Other logistics">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblOtherLog" runat="server" Text='<%# Eval("Other logistics") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Review Requirements/final Approver">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblReviewApp" runat="server" Text='<%# Eval("Review Requirements/final Approver") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="DH#">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblDH" runat="server" Text='<%# Eval("DH#") %>'></asp:Label>
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>
                                                ...
                                                <td>
                                                    <fieldset>
                                                        ...
                                                        <table align="center" width="300px">
                                                            <tr>
                                                                <td align="center">
                                                                    <asp:Button ID="btnScopeDocu" runat="server" Text="Scope Document" />
                                                                </td>
                                                                <td align="center">
                                                                    &nbsp;
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Button ID="btnMeasPlan" runat="server" Text="Measurement Plan" />
                                                                </td>
                                                                <td align="center">
                                                                    <asp:Button ID="btnIntakeForm" runat="server" Text="Intake Form" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </fieldset>
