<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" EnableEventValidation ="false" 
    CodeFile="ShowRecordsStandalone.aspx.cs" Inherits="ShowRecords_Program" %>
                                                    ...
                                                    <table width="600px" align="center" cellspacing="2" cellpadding="2">
                                                        <tr>
                                                            ...
                                                            <td align="left" valign="top">
                                                                <asp:CompareValidator ID="cvCol" runat="server" ControlToValidate="ddlCol"
                                                            ...
                                                            <td align="left" valign="top">
                                                                <asp:CompareValidator ID="cvOpe" runat="server" ControlToValidate="ddlOpe"
                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <div style="width: 90%; height: 450px; overflow: auto;">
                                        <asp:GridView ID="grdShowRecordsScope" runat="server" AutoGenerateColumns="False" Width="100%">
